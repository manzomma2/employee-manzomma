...
class EmployeeStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'grade_effective_dates.*' => 'nullable|date',
            ...
            'training_courses_start_dates.*' => 'nullable|date',
            'training_courses_end_dates.*' => 'nullable|date',
            'deduction_values' => 'array',
            'deduction_reasons' => 'array',
            'deduction_dates' => 'array',
            'deduction_values.*' => 'nullable|numeric|min:0|max:999999.99',
            'deduction_reasons.*' => 'nullable|string|max:255',
            'deduction_dates.*' => 'nullable|date',
            'evaluation_from_dates' => 'array',
            'evaluation_to_dates' => 'array',
            'evaluation_degrees' => 'array',
            'evaluation_ratings' => 'array',
            'evaluation_from_dates.*' => 'nullable|date',
            'evaluation_to_dates.*' => 'nullable|date',
            'evaluation_degrees.*' => 'nullable|string|max:255',
            'evaluation_ratings.*' => 'nullable|string|max:255',
            'settlement_decisions' => 'array',
            'settlement_dates' => 'array',
            'settlement_decisions.*' => 'nullable|string|max:255',
            'settlement_dates.*' => 'nullable|date',
            'bonus_numbers' => 'array',
            'bonus_values' => 'array',
            'bonus_dates' => 'array',
            'bonus_decisions' => 'array',
            'bonus_numbers.*' => 'nullable|string|max:255',
            'bonus_values.*' => 'nullable|numeric|min:0|max:999999.99',
            'bonus_dates.*' => 'nullable|date',
            'bonus_decisions.*' => 'nullable|string|max:255',
            'incentive_numbers' => 'array',
            'incentive_decisions' => 'array',
            'incentive_values' => 'array',
            'incentive_dates' => 'array',
            'incentive_numbers.*' => 'nullable|string|max:255',
            'incentive_decisions.*' => 'nullable|string|max:255',
            'incentive_values.*' => 'nullable|numeric|min:0|max:999999.99',
            'incentive_dates.*' => 'nullable|date',
        ];
    }
